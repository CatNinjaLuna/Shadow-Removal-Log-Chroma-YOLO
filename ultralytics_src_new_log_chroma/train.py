...
if __name__ == '__main__':
    ...
    # model.load(r'D:\论文\训练版\yolov10-main\\runs\\best.pt') # 是否加载预训练权重,科研不建议大家加载否则很难提升精度
    model = YOLO(r'/projects/SuperResolutionData/carolinali-shadowRemoval/ultralytics-src-new/yolo11s.pt')

    model.train(
                data=r'/projects/SuperResolutionData/carolinali-shadowRemoval/data/log_chroma_splitted_data/data.yaml',  #  将data后面替换你自己的数据集地址
