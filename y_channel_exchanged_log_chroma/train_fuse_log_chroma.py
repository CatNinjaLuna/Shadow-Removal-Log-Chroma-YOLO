...
if __name__ == '__main__':
    ...
    # /projects/SuperResolutionData/carolinali-shadowRemoval/ultralytics_baseline/ultralytics/cfg/models/11/yolo11.yaml

    model = YOLO(r'./yolo11s.pt')

    model.train(
                data=r'/projects/SuperResolutionData/carolinali-shadowRemoval/Y_Channel_Exchange/fuse_log_chroma_data/fuse_log_chroma_data.yaml',  #  将data后面替换你自己的数据集地址
