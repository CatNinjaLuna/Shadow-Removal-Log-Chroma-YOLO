...
def main():
    ...
    p.add_argument('--images', type=str, default="/projects/SuperResolutionData/carolinali-shadowRemoval/Y_Channel_Exchange/fuse_log_chroma_png_8bit")#path:fuse_log_chroma to png
    p.add_argument('--labels', type=str, default=r"/projects/SuperResolutionData/carolinali-shadowRemoval/data/log_chroma_txt")
    p.add_argument('--out', type=str, default="/projects/SuperResolutionData/carolinali-shadowRemoval/Y_Channel_Exchange/fuse_log_chroma_data")
