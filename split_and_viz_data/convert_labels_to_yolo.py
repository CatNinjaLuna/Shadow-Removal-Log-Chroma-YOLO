...
def main():
    ...
    p.add_argument('--label_dir', type=str, default='/projects/SuperResolutionData/carolinali-shadowRemoval/data/label')
    #p.add_argument('--image_dir', type=str, default='/projects/SuperResolutionData/carolinali-shadowRemoval/output_yolo/log_chroma')
    p.add_argument('--image_dir', type=str, default='/projects/SuperResolutionData/carolinali-shadowRemoval/output_yolo_all/log_chroma')

    p.add_argument('--out_dir', type=str, default='/projects/SuperResolutionData/carolinali-shadowRemoval/data/annotated_log_chroma_txt')
    p.add_argument('--exts', type=str, nargs='*', default=['.tif', '.png', '.jpg', '.jpeg'])
    args = p.parse_args()
