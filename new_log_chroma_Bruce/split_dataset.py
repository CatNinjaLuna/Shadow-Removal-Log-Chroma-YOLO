...
def main():
    ...
    p.add_argument('--images', type=str, default="/projects/SuperResolutionData/carolinali-shadowRemoval/new_log_chroma_Bruce/log_chroma_outputs/png")
    p.add_argument('--labels', type=str, default=r"/projects/SuperResolutionData/carolinali-shadowRemoval/new_log_chroma_Bruce/log_chroma_txt")
    p.add_argument('--out', type=str, default="/projects/SuperResolutionData/carolinali-shadowRemoval/new_log_chroma_Bruce/log_chroma_splitted_data")
