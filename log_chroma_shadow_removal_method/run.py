...
'''
# Paths
RAW_IMAGE_DIR = "/projects/SuperResolutionData/driving/ROD_dataset/Dataset/RawFiles/dataset"
SR_MAP_DIR = "/projects/SuperResolutionData/carolinali-shadowRemoval/raw_to_tiff_output"
LOG_CHROMA_OUTPUT_DIR = "/projects/SuperResolutionData/carolinali-shadowRemoval/log_chroma_output"
'''


RAW_IMAGE_DIR = "/projects/SuperResolutionData/carolinali-shadowRemoval/first_11_raw_files"
SR_MAP_DIR = "/projects/SuperResolutionData/carolinali-shadowRemoval/raw_to_tiff_output_test_1"
LOG_CHROMA_OUTPUT_DIR = "/projects/SuperResolutionData/carolinali-shadowRemoval/log_chroma_output_test_1"
...
def main():
    ...
    for img_name in tif_filenames:
        ...
        #img_path = f'data/images/network_inputs/{img_name}.tif'
        img_path = f'/Users/carolina1650/Spectral_Ratio_Illumination_Demo/data/images/network_inputs/day-02000.tif'


        #sr_map_path = f'data/sr_maps/{img_name}_isd.tiff' 
        sr_map_path = f'/Users/carolina1650/Spectral_Ratio_Illumination_Demo/data/sr_maps/day-02000_unet_resnet50_isd_map.tif'
        ...
        sr_map = cv2.resize(sr_map, (1280, 1280))  # (width, height) # resize to match input image size
