...
def main():
    ...
    p.add_argument('--image_dir', type=str, default="/projects/SuperResolutionData/carolinali-shadowRemoval/output_yolo_all")
    p.add_argument('--out_dir', type=str, default="/projects/SuperResolutionData/carolinali-shadowRemoval/data/log_chroma_txt")
