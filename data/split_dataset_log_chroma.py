...
def main():
    ...
    p.add_argument('--labels', type=str, default='/projects/SuperResolutionData/carolinali-shadowRemoval/data/annotated_log_chroma_txt')
    p.add_argument('--out', type=str, default='/projects/SuperResolutionData/carolinali-shadowRemoval/data/split')
...
'''
(SR-shadow-removal) [li.yuhan5@d1019 data]$ python /projects/SuperResolutionData/carolinali-shadowRemoval/data/split_dataset_log_chroma.py
